...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/static/css/main-page.css">
</head>
<body>
<div class="page-wrapper">
    <div class="container">
                        ...
                        <div class="record">
                            ...
                            <div class="record__controls">
                                <c:if test="${record.status =='ACTIVE'}">
                                    <form action="/make-record-done" method="post" class="record__controls-form" accept-charset="UTF-8">
                                        <input type="hidden" name="id" value="${record.id}">
                                        <input type="hidden" name="filter" value="${fn:toUpperCase(param.filter)}">
                ...
                <c:otherwise>
                    <c:choose>
                        ...
                        <c:when test="${fn:toLowerCase(param.filter)=='done'}">
                            <span>Нет выпаленных задач </span>
                        </c:when>
                        <c:otherwise>
                            <div class="hint">
                                <span>Задач нет. Попробуйте добавить задачу</span>
                            </div>
                        </c:otherwise>
        ...
        <div class="management-container">
            <form action="/add-record" method="post" class="management-form" accept-charset="UTF-8">
